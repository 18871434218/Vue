...
const pasreCoatingPoint = async(roadNodes) => {
    ...
    for (const val of roadNodes) {
        ...
        //         InsertPoints = [copystartNode, val, copyendNode];
...
const insertStationEBTAPoint = async(content) => {
    const logger1 = logger.scope('insertStationEBTAPoint');
    const roadNodes = content[0].roadNodes;
    const startNodes = roadNodes[0].node;
    const startAction = roadNodes[0].todo.action;
    const endNodes = roadNodes[1].node;
    const endAction = roadNodes[1].todo.action;

    let copystartNode1 = JSON.parse(JSON.stringify(point1));
    let copyendNode1 = JSON.parse(JSON.stringify(point1));
    let copystartNode = JSON.parse(JSON.stringify(point1));
    let copyendNode = JSON.parse(JSON.stringify(point1));

    // if (startNodes === 6) {
    //     copystartNode1.node = 1;
    //     copyendNode1.node = 1;
    //     if (startAction === 11) {
    //         copystartNode1.todo.action = 11;
    //         copystartNode1.todo.endLevel = 1;
    //         copystartNode1.insert = -1;
    //         content[0].roadNodes.splice(0, 0, copystartNode1);
    //         copyendNode1.todo.action = 13;
    //         copyendNode1.insert = 1;
    //         content[0].roadNodes.splice(2, 0, copyendNode1);
    //     } else if (startAction === 12) {
    //         copystartNode1.todo.action = 13;
    //         copystartNode1.todo.endLevel = 1;
    //         copystartNode1.insert = -1;
    //         content[0].roadNodes.splice(0, 0, copystartNode1);
    //         copyendNode1.todo.action = 13;
    ...
    //     }
    // } else {
    //     logger1.error('数据类型不对，该点非工位点start');
    //     throw new Error('数据类型不对，该点非工位点start');
    // }
    ...
    //         copystartNode.todo.endLevel = 1;
    //         copystartNode.insert = -1;
    //         content[0].roadNodes.splice(3, 0, copystartNode);
    //         copyendNode.todo.action = 13;
    //         copyendNode.insert = 1;
    //         content[0].roadNodes.splice(5, 0, copyendNode);
    ...
    //     }
    // } else {
    //     logger1.error('数据类型不对，该点非工位点end');
    //     throw new Error('数据类型不对，该点非工位点end');
    // }

    if (startNodes === 1) {
        copystartNode1.node = 23;
        copyendNode1.node = 23;
        if (startAction === 11) {
            copystartNode1.todo.action = 11;
            copystartNode1.todo.endLevel = 1;
            copystartNode1.insert = -1;
    ...
    } else if (startNodes === 2) {
        copystartNode1.node = 29;
        copyendNode1.node = 29;
        if (startAction === 11) {
            copystartNode1.todo.action = 11;
            copystartNode1.todo.endLevel = 1;
            copystartNode1.insert = -1;
    ...
    } else if (startNodes === 3) {
        copystartNode1.node = 35;
        copyendNode1.node = 35;
        if (startAction === 11) {
            copystartNode1.todo.action = 11;
            copystartNode1.todo.endLevel = 1;
            copystartNode1.insert = -1;
        ...
        copystartNode1.node = 12;
        copyendNode1.node = 12;
        if (startAction === 11) {
            copystartNode1.todo.action = 11;
            copystartNode1.todo.endLevel = 1;
            copystartNode1.insert = -1;
    ...
    } else if (startNodes === 6) {
        copystartNode1.node = 11;
        copyendNode1.node = 11;
        if (startAction === 11) {
            copystartNode1.todo.action = 11;
            copystartNode1.todo.endLevel = 1;
            copystartNode1.insert = -1;
