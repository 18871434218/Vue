        ...
        add_line() {
            ...
            }
            {
                ...
                if (this.find_road_line(new_line).exist) {
                    this.line_info.SpeedPercent = this.carSpeedPerent;
                    this.line_info.ExtraCost = this.carSpeedPerent;
                    this.line_info.MotionType = this.carMotionType;
                    this.line_info.ObstacleAvoid = this.carObstacleAvoid;
                    this.line_info.EnterStation = this.carEnterStation;
