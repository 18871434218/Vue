...
export async function newParseTask(mission: Mission) {
    ...
    let taskContent = [];
    const taskId = `${Math.random().toString(16).substr(2, 8)}`;
...
export async function parseTaskContent(content: any) {
    let contents = [];
...
export async function parseTaskProcess(content: any) {
    let process = [];
    for (const val of content) {
       const roadMap = val.roadMap;
...
export async function parseNodes(roadNode: any) {
...
export async function parseNodeProcess(roadNodes: any) {
...
export async function preInsertCoatingNode(content: any) {
...
export async function preInsertEBTANode(content: any) {
...
export const InsertPoint = async(content: any) => {
...
export async function pasreRoadNodeInsertPoint(roadMap: string, roadNodes: any) {
    let roadPonits: any[] = [];
...
export async function praseActionInsertLevel(PointObject: any, currentPoint: Point, currentAction: number) {
...
export async function startPointParse(startPoint: Point, currentAction: number) {
...
export async function endPointParse(endPoint: Point) {
...
export async function queryCurWeightAndCurNodeAndTaskType(mission: any) {
