    ...
    <el-tabs v-model="selectInformation" class="tab">
      <el-tab-pane label="基本信息" name="basicInformation">
        <el-form>
          ...
          <el-form-item label="位置：">{{ deviceLocation }}</el-form-item>
          <el-form-item label="航向角：">{{ deviceLocation}}</el-form-item>
        </el-form>
      </el-tab-pane>
...
export default {
  ...
  computed: {
    ...
    carId() {
      return this.currentSelectCarMission.carId;
    },
    ...
    deviceLocation() {
      return this.currentSelectCarMission.currentPosition;
    },
